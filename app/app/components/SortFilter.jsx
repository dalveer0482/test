                ...
                <Disclosure as="div" key={filter.id} className="w-full">
                  {({open}) => (
                    <>
                      ...
                      <ul key={filter.id} className={`py-2 ${filter.label == "Color" ? "color_filter" : filter.label == "Size" ? "size_filter" : ""}`}>
                     
                          {filter.label == "Color" ? (filter.values?.map((option) => {
                            return (
                              <li key={option.id} className={` pb-4 ${option.label}`}>
